...
/* cube::RandomWalkBehavior::RandomWalkBehavior @ 004dbf10  kind=game  attributed-by=rtti  size=16 */
...
/* cube::RandomWalkBehavior::vfunction1 @ 004dbf20  kind=game  attributed-by=rtti  size=704 */
...

{
  ...
  local_c = DAT_0076aa78 ^ (uint)&local_5c;
  *(ushort *)(param_1 + 0x124) = *(ushort *)(param_1 + 0x124) & 0xffbf;
  ...
  iVar3 = (this->RandomWalkBehavior_data).offset_0x0;
  if ((int)pRVar1->offset_0x0 < 0) {
    iVar3 = 0;
  }
  local_58 = param_1;
  (this->RandomWalkBehavior_data).offset_0x0 = iVar3;
  local_4c = this;
  if (iVar3 == 0) {
    ...
    iVar3 = local_54 - *(uint *)(param_1 + 0x1c8);
    iVar7 = ((int)local_5c - *(int *)(param_1 + 0x1cc)) -
            (uint)(local_54 < *(uint *)(param_1 + 0x1c8));
    local_20 = iVar3;
    local_1c = iVar7;
    uVar10 = __allmul(local_28,local_24,local_28,local_24);
    uVar10 = __alldiv(uVar10,0x10000,0);
    iVar4 = (int)((ulonglong)uVar10 >> 0x20);
    local_48 = (uint)uVar10;
    uVar10 = __allmul(iVar3,iVar7,iVar3,iVar7);
    uVar10 = __alldiv(uVar10,0x10000,0);
    iVar7 = local_58;
    ...
    iVar6 = iVar3 + uVar2;
    if ((iVar6 < 0) ||
       ((iVar6 == 0 || SCARRY4(iVar4,iVar5) != SCARRY4(iVar3,uVar2) &&
        (local_48 + (uint)uVar10 < 0x640001)))) {
      iVar3 = rand();
      local_5c = ((float)iVar3 * 2.0) / 32767.0 - 1.0;
      iVar3 = rand();
      *(float *)(local_58 + 0x40) = local_5c * 10.0;
      *(undefined4 *)(local_58 + 0x48) = 0;
      *(float *)(local_58 + 0x44) = (((float)iVar3 * 2.0) / 32767.0 - 1.0) * 10.0;
      iVar7 = local_58;
    }
    else {
      ...
      *(float *)(iVar7 + 0x40) = fVar9 * *(float *)(iVar7 + 0x40) * 10.0;
      *(float *)(iVar7 + 0x44) = *(float *)(iVar7 + 0x44) * fVar9 * 10.0;
      *(float *)(iVar7 + 0x48) = *(float *)(iVar7 + 0x48) * fVar9 * 10.0;
    }
    iVar3 = rand();
    (local_4c->RandomWalkBehavior_data).offset_0x0 = iVar3 % 5000 + 3000;
...
/* cube::RandomWalkBehavior::vfunction2 @ 004dc1e0  kind=game  attributed-by=rtti  size=31 */

undefined4 * __thiscall cube::RandomWalkBehavior::vfunction2(void)
