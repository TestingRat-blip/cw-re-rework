// Unsorted_004_03 (game_misc) -- server. 28 functions. Bodies = Ghidra pseudo-C.
// Attribution: see ../attribution.tsv. Toolchain of the original: MSVC 11.0 (VS2012).
#include "Unsorted_004_03.h"
...
/* FUN_0052e73a @ 0052e73a  kind=gamemisc  attributed-by=none  size=128 */

void __fastcall FUN_0052e73a(int param_1,float *param_2)

{
  ...
  do {
    fVar2 = (*param_2 - *in_EAX) * in_XMM2_Da + *in_EAX;
    *in_EAX = fVar2;
    fVar2 = (*param_2 - fVar2) * in_XMM2_Da + fVar2;
    *in_EAX = fVar2;
    fVar2 = (*param_2 - fVar2) * in_XMM2_Da + fVar2;
    *in_EAX = fVar2;
    *in_EAX = (*param_2 - fVar2) * in_XMM2_Da + fVar2;
    unaff_ESI = unaff_ESI + -1;
  } while (unaff_ESI != 0);
  if (unaff_EDI < param_1) {
    iVar1 = param_1 - unaff_EDI;
    do {
      *in_EAX = (*param_2 - *in_EAX) * in_XMM2_Da + *in_EAX;
      iVar1 = iVar1 + -1;
    } while (iVar1 != 0);
  }
  return;
