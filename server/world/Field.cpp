// Field (world) -- server. 3 functions. Bodies = Ghidra pseudo-C.
// Attribution: see ../attribution.tsv. Toolchain of the original: MSVC 11.0 (VS2012).
#include "Field.h"

/* cube::Field::Field @ 004133c0  kind=game  attributed-by=rtti  size=58 */
...
/* cube::Field::~Field @ 00413400  kind=game  attributed-by=rtti  size=21 */
...
/* cube::Field::scalar_deleting_destructor @ 00549170  kind=game  attributed-by=rtti  size=85 */

undefined4 * __thiscall cube::Field::scalar_deleting_destructor(Field *this,uint param_1)
