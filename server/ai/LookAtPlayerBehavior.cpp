...
/* cube::LookAtPlayerBehavior::LookAtPlayerBehavior @ 00414720  kind=game  attributed-by=rtti  size=9 */
...
/* cube::LookAtPlayerBehavior::vfunction1 @ 00414730  kind=game  attributed-by=rtti  size=646 */

void __thiscall cube::LookAtPlayerBehavior::vfunction1(LookAtPlayerBehavior *this,int param_1)

{
  ...
  fVar12 = 64.0;
  puVar2 = (undefined4 *)**(undefined4 **)(in_stack_00000008 + 4);
  iVar10 = 0;
  while (puVar2 != *(undefined4 **)(in_stack_00000008 + 4)) {
    iVar3 = puVar2[6];
...
/* cube::LookAtPlayerBehavior::vfunction2 @ 004149c0  kind=game  attributed-by=rtti  size=24 */

undefined4 * __thiscall cube::LookAtPlayerBehavior::vfunction2(LookAtPlayerBehavior *this)
